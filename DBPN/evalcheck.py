...
parser.add_argument('--test_dataset', type=str, default='coin')#Set5_LR_x4
parser.add_argument('--model_type', type=str, default='DBPN-RES-MR64-3')
parser.add_argument('--residual', type=bool, default=True)
parser.add_argument('--model', default='weights/DBPN-RES 100,10 ps-32/DIV2K_train_HRtek-ift-00103DBPN-RES-MR64-3tpami_residual_filter8_epoch_99.pth', help='sr pretrained base model')
#weights/DIV2K_train_HRtek-ift-00103DBPNtpami_residual_filter8_epoch_9.pth
...
def eval():
    ...
    for batch in testing_data_loader:
        ...
        save_img(input.cpu().data, name[0]+"i")
        save_img(bicubic.cpu().data, name[0]+"b")
...
def chop_forward(x, model, scale, shave=8, min_size=80000, nGPUs=1):
    b, c, h, w = x.size()
