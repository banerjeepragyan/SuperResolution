...
def main():
    ...
    if mode == 'single':
        opt['input_folder'] = './data/DIV2K/train_HR'
        opt['save_folder'] = './data/DIV2K/DIV2K800_sub_coin'
        opt['crop_sz'] = 480  # the size of each sub-image
        opt['step'] = 240  # step of the sliding crop window
        opt['thres_sz'] = 48  # size threshold
        extract_signle(opt)
    elif mode == 'pair':
        GT_folder = './data/DIV2K/train_HR'
        LR_folder = './data/DIV2K/train_LR'
        save_GT_folder = './data/DIV2K/DIV2K800_sub_coin'
        save_LR_folder = './data/DIV2K/DIV2K800_sub_bicLRx4_coin'
        scale_ratio = 4
