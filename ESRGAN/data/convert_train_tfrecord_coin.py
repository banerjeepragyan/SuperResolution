...
flags.DEFINE_string('hr_dataset_path', './data/DIV2K/new-coin-HR',
                    'path to high resolution dataset')
flags.DEFINE_string('lr_dataset_path', './data/DIV2K/new-coin-LR',
                    'path to low resolution dataset')
flags.DEFINE_string('output_path', './data/DIV2K800_sub_bin_coin_newd.tfrecord',
